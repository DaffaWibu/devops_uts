pipeline {
    ...
    environment {
        ...
        DEPLOY_HOST = "3.0.101.134"  // Ganti dengan IP instance AWS-mu
        SSH_CREDENTIALS_ID = "daffa_ssh"  // ID credential SSH di Jenkins
        APP_DIR = "/home/ec2-user/app/devops_uts"
        GIT_REPO = "https://github.com/DaffaWibu/devops_uts.git"
    }
...
/* dibawah ini adalah konfigurasi ci NO2
pipeline {
    agent any
